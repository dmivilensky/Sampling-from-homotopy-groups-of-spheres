...
class EvolutionarySampler:
    def __init__(
        ...
        exploration_rate=None, baseline="free", **kwargs):
    ...
    def __next__(self):
        ...
        print('INFO: evolutionary extension succeeded')
        return word
...
if __name__ == "__main__":
    ...
    sampler = EvolutionarySampler(
        baseline="joint", generators_number=3, 
        max_length=25, max_iters=100, mutation_rate=0.8, 
        exploration_rate=1., verbose=True,
        method='gemmate', fixed_size=False)
